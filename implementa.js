...
var empresa;
(function (empresa) {
    var p = new empresa.Pessoa("Paulo Felix", "000.000.000-90");
    p.setIdade(30);
    ...
    var g = new empresa.Gerente("Oswaldo", "555.555.555-55");
    g.setIdade(32);
    ...
    var tbFuncionario = document.getElementById("tbFuncionario");
    e.getFuncionario().forEach(function (e) {
        var nome = e.getNome();
        if (e instanceof empresa.Gerente) {
            nome += " - Gerente";
        }
        var html = "<tr><td>" + nome + "</td><td>" + e.getCodFuncionario() + "</td></tr>";
